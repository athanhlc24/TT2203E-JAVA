...
public class Tamgiac {
    ...
    // constructtor tên của nó phaỉ giống tên class
    public Tamgiac(){// hàm khởi tạo
        System.out.println("Vừa tạo xong đối tượng chạy vào đây luôn mặc định chạy k viết return vào hàm nayỳ ");
